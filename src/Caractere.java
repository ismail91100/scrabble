...
public class Caractere {
	...
	public boolean equals( Caractere b){
		boolean r=true;
		if (this.caractere== b.caractere||b.caractere=='-') r=true;
		else r=false;
		return r;
	}
	public boolean equals( char b){
		boolean r=true;
		if (this.caractere== b || b=='-') r=true;
		else r=false;
		return r;
	}
...
public int getY(){
	...
	public void swap( Caractere caractere2) {
		
		Caractere tmp= new Caractere(this.getCaractere());
		setCaractere(caractere2.getCaractere());
		caractere2.setCaractere(tmp.getCaractere());
