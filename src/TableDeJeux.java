...
public class TableDeJeux {
	...
	public void lesJoueurs(){
		...
		scrorej1.add(new JLabel(j1.getScoreString()));
		...
		scrorej2.add(new JLabel(j2.getScoreString()));
		...
		scrorej3.add(new JLabel(j3.getScoreString()));
		...
		scrorej4.add(new JLabel(j4.getScoreString()));
	...
	public Caractere getLettreEnMain(){
		...
		public void voirLesChevalet(){
			j1.voirChevaletDu(panelj1,this);
			j2.voirChevaletDu(panelj2,this);
			j3.voirChevaletDu(panelj3,this);
			j4.voirChevaletDu(panelj4,this);
		}
